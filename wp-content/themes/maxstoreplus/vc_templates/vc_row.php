...
if ( ! empty( $parallax_theme ) ) {
	$css_classes[] = 'bg-parallax';
}

if ( $disable_overflow == 1 ) {
    $css_classes[] = 'disable_overflow';
}

if ( ! empty( $half_background ) ) {
	$css_classes[] = 'half-background';
}
...
$wrapper_attributes[] = 'class="'.$parallax.' ' . esc_attr( trim( $css_class ) ) . '"';


$output .= '<div ' . implode( ' ', $wrapper_attributes ) . '>';
if ( $overlay != '' ) {
    $output .= '<div class="' . $overlay . '" style="background: ' . $color_overlay . '"></div>';
}
